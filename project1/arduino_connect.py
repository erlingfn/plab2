...
# arport = Arduino device port, which you can find at the bottom of your arduino window
# or via Arduino menu options tools/port.
#  The default will probably NOT work for your machine, but it may look quite similar,
# differing only in the final 4 digits.
